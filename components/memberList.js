...
import { View, Text,Image, FlatList, TouchableHighlight ,useColorScheme,ToastAndroid} from "react-native";
    ...
    return(
        <View style={{flex:1, backgroundColor:isDarkMode ? '#121212' : '#FFFFFF'}}>
            ...
            <View style={{alignItems:"center", flexDirection:"row", justifyContent:"space-between",marginVertical:20}}>
                <View style={{height:70,width:"100%",borderBottomWidth:0.5, borderColor:"gray", alignItems: "center",backgroundColor:isDarkMode ? '#121212' : '#FFFFFF',justifyContent:"space-between", flexDirection: "row",paddingHorizontal:10, marginBottom: 5 }}>
                    ...
                    <Text style={{ fontSize: 22, color:isDarkMode ? '#FFFFFF' : '#000000', fontWeight: "800" }}>Members List</Text>
                    <Ionicons name="people-sharp" size={25} color={isDarkMode ? '#FFFFFF' : '#000000'} />

                </View>
            </View>

            <View style={{paddingHorizontal:15, marginBottom:10}}>
                <Searchbar elevation={2}  style={{backgroundColor:isDarkMode ? "rgba(50, 50, 50, 1)" : '#FFFFFF', color:isDarkMode ? '#FFFFFF' : '#000000',marginBottom:5}} cursorColor={"gray"}  value={search}  iconColor={isDarkMode ? '#FFFFFF' : '#000000'} onChangeText={(text)=> {searchQueryHandler(text)}} placeholderTextColor={'gray'} placeholder="Search by name"/>
            </View>
                        ...
                        renderItem={({item , index}) => {
                            return(
                                ...
                                <View style={{alignItems:"center", flexDirection:"row", justifyContent:"space-around"}}>
                                        ...
                                        <>
                                            <TouchableHighlight onPress={()=>{getMember(item.FirstName, item.SecondName)}} underlayColor={isDarkMode ? "rgba(70, 70, 70, 1)":"lightgray"} style={{height:50, width:"100%",paddingHorizontal:10,elevation:4, alignItems:"center",flexDirection:"row", justifyContent:"space-between", borderBottomRightRadius:50, borderTopRightRadius:50, borderTopLeftRadius:50,borderBottomLeftRadius:50, backgroundColor:isDarkMode ?  "rgba(50, 50, 50, 1)" : '#FFFFFF' }}>
