        ...
        <View style={{flex:1,justifyContent:"space-between"}}>
                    ...
                    <View style={{alignItems:"center", flexDirection:"row", justifyContent:"space-between",marginBottom:5}}>
                            <View style={{height:70,width:"18%",justifyContent:"center",borderBottomRightRadius:50,padding:10,borderTopRightRadius:50, backgroundColor:"white",elevation:6}}>
                                <MaterialIcons name="dashboard"  color={"rgba(0, 0, 128, 0.8)"} size={35}/>
                            </View>
                    ...
                    <View style={{padding:10,}}>
                        ...
                        <View style={{marginTop:10,alignItems:"center", flexDirection:"row", justifyContent:"space-around"}}>
                            ...
                            <>
                                <TouchableOpacity onPress={()=> {navigation.replace("Registration")}} style={{height:130, width:"48%",padding:5,alignItems:"center",justifyContent:"space-around",borderRadius:20, backgroundColor:"white", elevation:6 }}>
                            ...
                            <>
                                <TouchableOpacity onPress={()=> {navigation.replace("Update Member Data")}} style={{height:130, width:"48%",padding:10,alignItems:"center",  justifyContent:"space-between",borderRadius:15, backgroundColor:"white", elevation:5 }}>
                        ...
                        <View style={{marginTop:15,alignItems:"center", flexDirection:"row", justifyContent:"space-around"}}>
                            <>
                                <TouchableOpacity onPress={()=> {navigation.replace("MemberList")}} style={{height:130, width:"48%",padding:5,alignItems:"center",justifyContent:"space-around",borderRadius:20, backgroundColor:"white", elevation:6 }}>
                            ...
                            <>
                                <TouchableOpacity onPress={()=> {navigation.replace("Attendance")}} style={{height:130, width:"48%",padding:10,alignItems:"center",  justifyContent:"space-between",borderRadius:15, backgroundColor:"white", elevation:5 }}>
                        ...
                        <View style={{marginTop:15,alignItems:"center", flexDirection:"row", justifyContent:"space-around"}}>
                            <>
                                <TouchableOpacity onPress={()=> {navigation.replace("Events",{id: "" ,image : null, name: "", guest: "", About: "", start:"" })}} style={{height:130, width:"48%",padding:5,alignItems:"center",justifyContent:"space-around",borderRadius:20, backgroundColor:"white", elevation:6 }}>
                            ...
                            <>
                                <TouchableOpacity onPress={()=> {navigation.replace("Send SMS")}} style={{height:130, width:"48%",padding:15,alignItems:"center",  justifyContent:"space-between",borderRadius:15, backgroundColor:"white", elevation:5 }}>
                        ...
                        <View style={{marginTop:15,alignItems:"center", flexDirection:"row", justifyContent:"space-around"}}>
                            <>
                                <TouchableOpacity onPress={()=> {navigation.replace("Receipt")}} style={{height:130, width:"48%",padding:5,alignItems:"center",justifyContent:"space-around",borderRadius:20, backgroundColor:"white", elevation:6 }}>
                            ...
                            <>
                                <TouchableOpacity onPress={()=> {}} style={{height:130, width:"48%",padding:15,alignItems:"center",  justifyContent:"space-between",borderRadius:15, backgroundColor:"white", elevation:5 }}>
                        ...
                        <View style={{marginTop:15,alignItems:"center", flexDirection:"row", justifyContent:"space-around"}}>
                            ...
                            <>
                                <TouchableOpacity onPress={()=> {}} style={{height:130, width:"48%",padding:5,alignItems:"center",justifyContent:"space-around",borderRadius:20, backgroundColor:"white", elevation:6 }}>
                                        ...
                                        <Text style={{fontSize:18,fontWeight:"400",color:"black"}}>Text</Text>
                                </TouchableOpacity>
                            </>
