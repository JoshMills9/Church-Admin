...
export const Notifications = ({route}) => {
    ...
    const {username, ChurchName, users, admin, role , mainEmail, events, newAdmin} = route.params
    ...
    <View  style={[styles.container,{justifyContent:"space-between",paddingHorizontal:20, paddingVertical:10}]}>
        <View style={{flex:1, justifyContent:"space-between",marginTop:20}}>
            ...
            <View style={{alignSelf:"center",alignItems:"center", marginVertical:20}}>
                <View  style={{position:"absolute", top:0,right:WindowHeight < 800 ? 80 :110, width:10, height:10, borderRadius:100, backgroundColor:"rgba(100, 200, 255, 1)"}} ></View>
                ...
                <Text style={{fontSize:14, color:"rgba(240, 240, 240, 0.8)"}}>{users?.length || 0} Account Connected</Text>
            </View>
