              ...
              <StatusBar barStyle={"light-content"} backgroundColor={"rgba(50, 50, 50, 1)"} />
                ...
                <View style={{marginHorizontal:15, height:500 ,paddingVertical:10,justifyContent:"center",}}>
                    ...
                    <View style={{marginTop:30,flexDirection:"row",justifyContent:"space-between", alignItems:"center"}}>
                        <Text style={{fontSize:18, fontWeight:"300",color:"rgba(240, 240, 240, 1)"}}>Full Name:</Text>
                        <Text style={{fontSize:18, fontWeight:"500",color:"rgba(240, 240, 240, 1)"}}>{member[0].FirstName} {member[0].SecondName}</Text>
                    </View>

                    <View style={{marginTop:15,flexDirection:"row",justifyContent:"space-between", alignItems:"center"}}>
                        <Text style={{fontSize:18, fontWeight:"300",color:"rgba(240, 240, 240, 1)"}}>Date Of Birth:</Text>
                        <Text  style={{fontSize:18, fontWeight:"500",color:"rgba(240, 240, 240, 1)"}}>{member[0].Date_Of_Birth}</Text>
                    </View>

                    <View style={{marginTop:15,flexDirection:"row",justifyContent:"space-between", alignItems:"center"}}>
                        <Text style={{fontSize:18, fontWeight:"300",color:"rgba(240, 240, 240, 1)"}}>Registration Date:</Text>
                        <Text  style={{fontSize:18, fontWeight:"500",color:"rgba(240, 240, 240, 1)"}}>{member[0].Registration_Date}</Text>
                    </View>

                    <View style={{marginTop:15,flexDirection:"row",justifyContent:"space-between", alignItems:"center"}}>
                        <Text style={{fontSize:18, fontWeight:"300",color:"rgba(240, 240, 240, 1)"}}>Phone Number 1:</Text>
                        <Text  style={{fontSize:18, fontWeight:"500",color:"rgba(240, 240, 240, 1)"}}>{member[0].Number1}</Text>
                    </View>

                    <View style={{marginTop:15,flexDirection:"row",justifyContent:"space-between", alignItems:"center"}}>
                        <Text style={{fontSize:18, fontWeight:"300",color:"rgba(240, 240, 240, 1)"}}>Phone Number 2:</Text>
                        <Text  style={{fontSize:18, fontWeight:"500",color:"rgba(240, 240, 240, 1)"}}>{member[0].Number2}</Text>
                    </View>

                    <View style={{marginTop:15,flexDirection:"row",justifyContent:"space-between", alignItems:"center"}}>
                        <Text style={{fontSize:18, fontWeight:"300",color:"rgba(240, 240, 240, 1)"}}>Email:</Text>
                        <Text  style={{fontSize:18, fontWeight:"500",color:"rgba(240, 240, 240, 1)"}}>{member[0].Email}</Text>
                    </View>

                    <View style={{marginTop:15,flexDirection:"row",justifyContent:"space-between", alignItems:"center"}}>
                        <Text style={{fontSize:18, fontWeight:"300",color:"rgba(240, 240, 240, 1)"}}>Residential Address:</Text>
                        <Text  style={{fontSize:18, fontWeight:"500",color:"rgba(240, 240, 240, 1)"}}>{member[0].Location}</Text>
                    </View>

                    <View style={{marginTop:15,flexDirection:"row",justifyContent:"space-between", alignItems:"center"}}>
                        <Text style={{fontSize:18, fontWeight:"300",color:"rgba(240, 240, 240, 1)"}}>Marital Status:</Text>
                        <Text  style={{fontSize:18, fontWeight:"500",color:"rgba(240, 240, 240, 1)"}}>{member[0].Marital_Status}</Text>
                    </View>

                    <View style={{marginTop:15,flexDirection:"row",justifyContent:"space-between", alignItems:"center"}}>
                        <Text style={{fontSize:18, fontWeight:"300",color:"rgba(240, 240, 240, 1)"}}>Department:</Text>
                        <Text  style={{fontSize:18, fontWeight:"500",color:"rgba(240, 240, 240, 1)"}}>{member[0].Department}</Text>
                    </View>

                    <View style={{marginTop:15,flexDirection:"row",justifyContent:"space-between", alignItems:"center"}}>
                        <Text style={{fontSize:18, fontWeight:"300",color:"rgba(240, 240, 240, 1)"}}>Baptized:</Text>
                        <Text  style={{fontSize:18, fontWeight:"500",color:"rgba(240, 240, 240, 1)"}}>{member[0].Baptized}</Text>
                    </View>

                    <View style={{marginTop:15,flexDirection:"row",justifyContent:"space-between", alignItems:"center"}}>
                        <Text style={{fontSize:18, fontWeight:"300",color:"rgba(240, 240, 240, 1)"}}>Visiting:</Text>
                        <Text  style={{fontSize:18, fontWeight:"500",color:"rgba(240, 240, 240, 1)"}}>{member[0].Visting}</Text>
                    </View>

                    <View style={{marginTop:15,flexDirection:"row",justifyContent:"space-between", alignItems:"center"}}>
                        <Text style={{fontSize:18, fontWeight:"300",color:"rgba(240, 240, 240, 1)"}}>Occupation:</Text>
                        <Text  style={{fontSize:18, fontWeight:"500",color:"rgba(240, 240, 240, 1)"}}>{member[0].occupation}</Text>
                    </View>
                    </ScrollView>
                </View>
